...
const GroupScreen = ({ navigation, route }) => {
  ...
  // Firestore writes
  const createGroupFirestore = async (name) => {
  ...
  const joinGroupByCode = async (code) => {
    ...
    if (snaps.empty) {
      return Alert.alert('Error', 'Invalid group code.');
    }
  ...
  const onCreateModalSubmit = () => {
    ...
    createGroupFirestore(groupName.trim())
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        {/* Join Modal */}
        <Modal transparent animationType="slide" visible={showJoinModal}>
        ...
        {/* Create Modal */}
        <Modal transparent animationType="slide" visible={showCreateModal}>
          <View style={styles.modalBackground}>
            <View style={styles.modalContainer}>
              ...
              <TextInput
                ...
                placeholderTextColor="#888"
                value={groupName}
                onChangeText={(t) => setGroupName(t.slice(0, 20))}
                autoCapitalize="none"
                maxLength={20}
              />
