...
//   //       [`slices.${inputText.trim()}`]: newEventData,
//   //     });
...
//     }
//     if (description.trim() === '') {
//       Alert.alert('This event currently has no description.', 'It may help your buddies to add information regarding the location, pricing, and any other important details.');
//     }
...
//       Alert.alert('Got it!', 'Event Added!');
//       navigation.goBack();
//     } catch (error) {
//       Alert.alert('Error', error.message);
//     }
...
//   const addDayAndTime = async () => {
//     if (!selectedDays.length || !startTime || !endTime) {
//       Alert.alert('Hold Up', 'Please insert a valid day and time.');
//       return;
//     }
